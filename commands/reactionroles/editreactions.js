...
module.exports = {
    name: "editreactions",
    description: "edits reaction roles of a message!",
        ...
        try {
            ...
            if (!fetchedMessage)
                ...
                if (msgModel) {
                    ...
                    let filter = m => m.content.toLowerCase() === 'add' || m.content.toLowerCase() === 'remove';
...
async function handleCollector(fetchedMessage, author, channel, msgModel, message, messageId) {
