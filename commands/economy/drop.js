...
module.exports = {
    ...
    async execute(client, message, args, Discord, profileData) {
        ...
        const filter = (msg) => msg.guild.id === message.guild.id && msg.content === `${process.env.PREFIX}pick`
        message.channel.send(`${coins} PandaCoins have been dropped in ${channel}`)
        channel.send(`Quick! ${coins} PandaCoins have been dropped!! Type ${process.env.PREFIX}pick to pick them up!!`)
